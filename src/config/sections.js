...
export const SECTIONS = {
  what_can_do: {
    ...
    promptFragment:
      'Сделай самый сильный и наиболее подробный ответ среди всех разделов: объясни ценность продукта, ключевые сценарии и будущую механику работы NAPOMNI. Обязательно подчеркни, что сейчас это demo и часть функций ещё в разработке.',
    isLeadCTA: false
  },
  account: {
    sectionKey: 'account',
